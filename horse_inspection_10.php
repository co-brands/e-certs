...
<!--	<script src="js/livestock_horse_10.js"></script>-->
...
$num_horse_country = ($num_horse_country_01 + $num_horse_country_02 + $num_horse_country_03 + $num_horse_country_04 + $num_horse_country_05 + $num_horse_country_06 + $num_horse_country_07 + $num_horse_country_08 + $num_horse_country_09 + $num_horse_country_10);
$num_horse_permit = ($num_horse_permit_01 + $num_horse_permit_02 + $num_horse_permit_03 + $num_horse_permit_04 + $num_horse_permit_05 + $num_horse_permit_06 + $num_horse_permit_07 + $num_horse_permit_08 + $num_horse_permit_09 + $num_horse_permit_10);

$num_horse_01 = ($num_horse_country_01 + $num_horse_permit_01);
$num_horse_02 = ($num_horse_country_02 + $num_horse_permit_02);
$num_horse_03 = ($num_horse_country_03 + $num_horse_permit_03);
$num_horse_04 = ($num_horse_country_04 + $num_horse_permit_04);
$num_horse_05 = ($num_horse_country_05 + $num_horse_permit_05);
$num_horse_06 = ($num_horse_country_06 + $num_horse_permit_06);
$num_horse_07 = ($num_horse_country_07 + $num_horse_permit_07);
$num_horse_08 = ($num_horse_country_08 + $num_horse_permit_08);
$num_horse_09 = ($num_horse_country_09 + $num_horse_permit_09);
$num_horse_10 = ($num_horse_country_10 + $num_horse_permit_10);
...
;
$remove_hb_fee_03 = $_POST['horse_movement_03'];
if (!empty($remove_hb_fee_03)){
$neg_hb_fee_03 = (($num_horse_country_03 + $num_horse_permit_03) * (-3));
}
;
$remove_hb_fee_04 = $_POST['horse_movement_04'];
if (!empty($remove_hb_fee_04)){
$neg_hb_fee_04 = (($num_horse_country_04 + $num_horse_permit_04) * (-3));
}
;
$remove_hb_fee_05 = $_POST['horse_movement_05'];
if (!empty($remove_hb_fee_05)){
$neg_hb_fee_05 = (($num_horse_country_05 + $num_horse_permit_05) * (-3));
}
;
$remove_hb_fee_06 = $_POST['horse_movement_06'];
if (!empty($remove_hb_fee_06)){
$neg_hb_fee_06 = (($num_horse_country_06 + $num_horse_permit_06) * (-3));
}
;
$remove_hb_fee_07 = $_POST['horse_movement_07'];
if (!empty($remove_hb_fee_07)){
$neg_hb_fee_07 = (($num_horse_country_07 + $num_horse_permit_07) * (-3));
}
;
$remove_hb_fee_08 = $_POST['horse_movement_08'];
if (!empty($remove_hb_fee_08)){
$neg_hb_fee_08 = (($num_horse_country_08 + $num_horse_permit_08) * (-3));
}
;
$remove_hb_fee_09 = $_POST['horse_movement_09'];
if (!empty($remove_hb_fee_09)){
$neg_hb_fee_09 = (($num_horse_country_09 + $num_horse_permit_09) * (-3));
}
;
$remove_hb_fee_10 = $_POST['horse_movement_10'];
if (!empty($remove_hb_fee_10)){
$neg_hb_fee_10 = (($num_horse_country_10 + $num_horse_permit_10) * (-3));
}
;
$neg_hb_fee = ($neg_hb_fee_01 + $neg_hb_fee_02 + $neg_hb_fee_03 + $neg_hb_fee_04 + $neg_hb_fee_05 + $neg_hb_fee_06 + $neg_hb_fee_07 + $neg_hb_fee_08 + $neg_hb_fee_09 + $neg_hb_fee_10);
...
clss_county_buyer, num_horse_01, num_horse_02, num_horse_03, num_horse_04,
num_horse_05, num_horse_06, num_horse_07, num_horse_08, num_horse_09, num_horse_10,
...
horse_breed_03, horse_breed_04, horse_breed_05, horse_breed_06, horse_breed_07, horse_breed_08,
horse_breed_09, horse_breed_10, horse_color_01, horse_color_02, horse_color_03, horse_color_04,
horse_color_05, horse_color_06, horse_color_07, horse_color_08, horse_color_09, horse_color_10,
horse_gender_01, horse_gender_02, horse_gender_03, horse_gender_04, horse_gender_05,
horse_gender_06, horse_gender_07, horse_gender_08, horse_gender_09, horse_gender_10,
horse_marking_all_01, horse_marking_all_02, horse_marking_all_03, horse_marking_all_04,
horse_marking_all_05, horse_marking_all_06, horse_marking_all_07, horse_marking_all_08,
horse_marking_all_09, horse_marking_all_10, horse_marking_bf_01, horse_marking_bf_02,
horse_marking_bf_03, horse_marking_bf_04, horse_marking_bf_05, horse_marking_bf_06,
horse_marking_bf_07, horse_marking_bf_08, horse_marking_bf_09, horse_marking_bf_10,
horse_marking_bh_01, horse_marking_bh_02, horse_marking_bh_03, horse_marking_bh_04,
horse_marking_bh_05, horse_marking_bh_06, horse_marking_bh_07, horse_marking_bh_08,
horse_marking_bh_09, horse_marking_bh_10, horse_marking_eyes_01, horse_marking_eyes_02,
horse_marking_eyes_03, horse_marking_eyes_04, horse_marking_eyes_05, horse_marking_eyes_06,
horse_marking_eyes_07, horse_marking_eyes_08, horse_marking_eyes_09, horse_marking_eyes_10,
horse_marking_head_01, horse_marking_head_02, horse_marking_head_03, horse_marking_head_04,
horse_marking_head_05, horse_marking_head_06, horse_marking_head_07, horse_marking_head_08,
horse_marking_head_09, horse_marking_head_10, horse_marking_lf_01, horse_marking_lf_02,
horse_marking_lf_03, horse_marking_lf_04, horse_marking_lf_05, horse_marking_lf_06, horse_marking_lf_07,
horse_marking_lf_08, horse_marking_lf_09, horse_marking_lf_10, horse_marking_lh_01, horse_marking_lh_02,
horse_marking_lh_03, horse_marking_lh_04, horse_marking_lh_05, horse_marking_lh_06, horse_marking_lh_07,
horse_marking_lh_08, horse_marking_lh_09, horse_marking_lh_10, horse_marking_rf_01, horse_marking_rf_02,
horse_marking_rf_03, horse_marking_rf_04, horse_marking_rf_05, horse_marking_rf_06, horse_marking_rf_07,
horse_marking_rf_08, horse_marking_rf_09, horse_marking_rf_10, horse_marking_rh_01, horse_marking_rh_02,
horse_marking_rh_03, horse_marking_rh_04, horse_marking_rh_05, horse_marking_rh_06, horse_marking_rh_07,
horse_marking_rh_08, horse_marking_rh_09, horse_marking_rh_10, 
...
inspection_notes
 ...
 "VALUES('$num_horses','$cert_date',
	 ...
	 '$clss_county_buyer','$num_horse_01','$num_horse_02','$num_horse_03','$num_horse_04','$num_horse_05','$num_horse_06',
	 '$num_horse_07','$num_horse_08','$num_horse_09','$num_horse_10','$output_horse_01','$output_horse_02',
	 '$output_horse_03','$output_horse_04','$output_horse_05','$output_horse_06','$output_horse_07',
	 '$output_horse_08','$output_horse_09','$output_horse_10','$horse_breed_01','$horse_breed_02',
	 '$horse_breed_03','$horse_breed_04','$horse_breed_05','$horse_breed_06','$horse_breed_07',
	 '$horse_breed_08','$horse_breed_09','$horse_breed_10','$horse_color_01','$horse_color_02',
	 '$horse_color_03','$horse_color_04','$horse_color_05','$horse_color_06','$horse_color_07',
	 '$horse_color_08','$horse_color_09','$horse_color_10','$horse_gender_01','$horse_gender_02',
	 '$horse_gender_03','$horse_gender_04','$horse_gender_05','$horse_gender_06','$horse_gender_07',
	 '$horse_gender_08','$horse_gender_09','$horse_gender_10','$horse_marking_all_01',
	 '$horse_marking_all_02','$horse_marking_all_03','$horse_marking_all_04','$horse_marking_all_05',
	 '$horse_marking_all_06','$horse_marking_all_07','$horse_marking_all_08','$horse_marking_all_09',
	 '$horse_marking_all_10','$horse_marking_bf_01','$horse_marking_bf_02','$horse_marking_bf_03',
	 '$horse_marking_bf_04','$horse_marking_bf_05','$horse_marking_bf_06','$horse_marking_bf_07',
	 '$horse_marking_bf_08','$horse_marking_bf_09','$horse_marking_bf_10','$horse_marking_bh_01',
	 '$horse_marking_bh_02','$horse_marking_bh_03','$horse_marking_bh_04','$horse_marking_bh_05',
	 '$horse_marking_bh_06','$horse_marking_bh_07','$horse_marking_bh_08','$horse_marking_bh_09',
	 '$horse_marking_bh_10','$horse_marking_eyes_01','$horse_marking_eyes_02','$horse_marking_eyes_03',
	 '$horse_marking_eyes_04','$horse_marking_eyes_05','$horse_marking_eyes_06','$horse_marking_eyes_07',
	 '$horse_marking_eyes_08','$horse_marking_eyes_09','$horse_marking_eyes_10','$horse_marking_head_01',
	 '$horse_marking_head_02','$horse_marking_head_03','$horse_marking_head_04','$horse_marking_head_05',
	 '$horse_marking_head_06','$horse_marking_head_07','$horse_marking_head_08','$horse_marking_head_09',
	 '$horse_marking_head_10','$horse_marking_lf_01','$horse_marking_lf_02','$horse_marking_lf_03',
	 '$horse_marking_lf_04','$horse_marking_lf_05','$horse_marking_lf_06','$horse_marking_lf_07',
	 '$horse_marking_lf_08','$horse_marking_lf_09','$horse_marking_lf_10','$horse_marking_lh_01',
	 '$horse_marking_lh_02','$horse_marking_lh_03','$horse_marking_lh_04','$horse_marking_lh_05',
	 '$horse_marking_lh_06','$horse_marking_lh_07','$horse_marking_lh_08','$horse_marking_lh_09',
	 '$horse_marking_lh_10','$horse_marking_rf_01','$horse_marking_rf_02','$horse_marking_rf_03',
	 '$horse_marking_rf_04','$horse_marking_rf_05','$horse_marking_rf_06','$horse_marking_rf_07',
	 '$horse_marking_rf_08','$horse_marking_rf_09','$horse_marking_rf_10','$horse_marking_rh_01',
	 '$horse_marking_rh_02','$horse_marking_rh_03','$horse_marking_rh_04','$horse_marking_rh_05',
	 '$horse_marking_rh_06','$horse_marking_rh_07','$horse_marking_rh_08','$horse_marking_rh_09',
	 '$horse_marking_rh_10',
	 '$horse_brand_location_01_LJ','$horse_brand_location_01_LN','$horse_brand_location_01_LS','$horse_brand_location_01_LR','$horse_brand_location_01_LH',
	 '$horse_brand_location_01_LT','$horse_brand_location_01_LB','$horse_brand_location_01_RJ','$horse_brand_location_01_RN','$horse_brand_location_01_RS',
	 '$horse_brand_location_01_RR','$horse_brand_location_01_RH','$horse_brand_location_01_RT','$horse_brand_location_01_RB','$horse_brand_location_01_DIM',
	 ...
	 '$horse_brand_location_10_RJ','$horse_brand_location_10_RN','$horse_brand_location_10_RS','$horse_brand_location_10_RR','$horse_brand_location_10_RH',
	 '$horse_brand_location_10_RT', '$horse_brand_location_10_RB', '$horse_brand_location_10_DIM', '$horse_brand_location_10_BOTCH', '$horse_brand_location_10_FREEZE',
	 '$horse_minimum_fee','$horse_service_charge_fee','$horse_board_fee','$horse_permit_fee',
...
echo "<h3>";
echo "<a href=\"pdf-output-horse-10.php?cert_serial_num=".$row['cert_serial_num']."\">Click here to view Stock Certificate: " . $row['cert_series']. $row['cert_insp_num'] . $new . "</a>";
echo "</h3>";
}
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_03" type="text" id="num_horse_country_03"><br>
# Travel Permits: <input name="num_horse_permit_03" type="text" id="num_horse_permit_03"><br>
Exemption: <input type="checkbox" name="horse_movement_03" value="no_min"><br>
Breed: <select size="1" name="horse_breed_03">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_03">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_03">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_03">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_03">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_03">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_03">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_03">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_03">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_03">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_03">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_03">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_04" type="text" id="num_horse_country_04"><br>
# Travel Permits: <input name="num_horse_permit_04" type="text" id="num_horse_permit_04"><br>
Exemption: <input type="checkbox" name="horse_movement_04" value="no_min"><br>
Breed: <select size="1" name="horse_breed_04">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_04">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_04">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_04">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_04">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_04">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_04">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_04">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_04">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_04">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_04">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_04">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_05" type="text" id="num_horse_country_05"><br>
# Travel Permits: <input name="num_horse_permit_05" type="text" id="num_horse_permit_05"><br>
Exemption: <input type="checkbox" name="horse_movement_05" value="no_min"><br>
Breed: <select size="1" name="horse_breed_05">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_05">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_05">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_05">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_05">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_05">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_05">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_05">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_05">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_05">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_05">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_05">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_06" type="text" id="num_horse_country_06"><br>
# Travel Permits: <input name="num_horse_permit_06" type="text" id="num_horse_permit_06"><br>
Exemption: <input type="checkbox" name="horse_movement_06" value="no_min"><br>
Breed: <select size="1" name="horse_breed_06">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_06">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_06">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_06">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_06">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_06">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_06">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_06">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_06">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_06">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_06">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_06">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_07" type="text" id="num_horse_country_07"><br>
# Travel Permits: <input name="num_horse_permit_07" type="text" id="num_horse_permit_07"><br>
Exemption: <input type="checkbox" name="horse_movement_07" value="no_min"><br>
Breed: <select size="1" name="horse_breed_07">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_07">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_07">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_07">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_07">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_07">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_07">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_07">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_07">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_07">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_07">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_07">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_08" type="text" id="num_horse_country_08"><br>
# Travel Permits: <input name="num_horse_permit_08" type="text" id="num_horse_permit_08"><br>
Exemption: <input type="checkbox" name="horse_movement_08" value="no_min"><br>
Breed: <select size="1" name="horse_breed_08">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_08">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_08">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_08">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_08">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_08">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_08">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_08">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_08">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_08">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_08">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_08">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_09" type="text" id="num_horse_country_09"><br>
# Travel Permits: <input name="num_horse_permit_09" type="text" id="num_horse_permit_09"><br>
Exemption: <input type="checkbox" name="horse_movement_09" value="no_min"><br>
Breed: <select size="1" name="horse_breed_09">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_09">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_09">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_09">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_09">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_09">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_09">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_09">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_09">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_09">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_09">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_09">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
...
<tr>
<td align="left" valign="top" rowspan="7" width="33%">
# Country: <input name="num_horse_country_10" type="text" id="num_horse_country_10"><br>
# Travel Permits: <input name="num_horse_permit_10" type="text" id="num_horse_permit_10"><br>
Exemption: <input type="checkbox" name="horse_movement_10" value="no_min"><br>
Breed: <select size="1" name="horse_breed_10">
<option value="">No Breed Selected</option>
<option value="Andalusian">Andalusian</option>
<option value="Appaloosa">Appaloosa</option>
<option value="Arabian">Arabian</option>
...
Gender: <select size="1" name="horse_gender_10">
<option value="">No Gender Selected</option>
<option value="Filly">Filly</option>
<option value="Gelding">Gelding</option>
<option value="Jack">Jack</option>
...
Color: <select size="1" name="horse_color_10">
<option value="">No Color Selected</option>
<option value="Bay">Bay</option>
<option value="Bay_Wht Pt">Bay &amp; Wht Pt</option>
<option value="Bay dun">Bay dun</option>
...
<td align="center" valign="top" colspan="2" width="33%">Eyes<br>
<select size="1" name="horse_marking_eyes_10">
<option value="">No Markings</option>
<option value="Both Eyes">Both</option>
<option value="Left Eye">Left</option>
<option value="Right Eye">Right</option>
...
<td align="center" valign="top" colspan="2"><p>
Head<br>
<select size="1" name="horse_marking_head_10">
<option value="">No Markings</option>
<option value="Bald Face Head">Bald Face</option>
<option value="Blaze Head">Blaze</option>
<option value="Half Bald Face Head">Half Bald Face</option>
...
<tr>
<td align="center" valign="top" colspan="2">ALL<br>
<select size="1" name="horse_marking_all_10">
<option value="">No Markings</option>
<option value="Cornet ALL">Cornet</option>
<option value="Half Cornet ALL">Half Cornet</option>
<option value="Half Pastern ALL">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BF<br>
<select size="1" name="horse_marking_bf_10">
<option value="">No Markings</option>
<option value="Cornet BF">Cornet</option>
<option value="Half Cornet BF">Half Cornet</option>
<option value="Half Pastern BF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LF<br>
<select size="1" name="horse_marking_lf_10">
<option value="">No Markings</option>
<option value="Cornet LF">Cornet</option>
<option value="Half Cornet LF">Half Cornet</option>
<option value="Half Pastern LF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RF<br>
<select size="1" name="horse_marking_rf_10">
<option value="">No Markings</option>
<option value="Cornet RF">Cornet</option>
<option value="Half Cornet RF">Half Cornet</option>
<option value="Half Pastern RF">Half Pastern</option>
...
<td align="center" valign="top">
<p align="left">LH<br>
<select size="1" name="horse_marking_lh_10">
<option value="">No Markings</option>
<option value="Cornet LH">Cornet</option>
<option value="Half Cornet LH">Half Cornet</option>
<option value="Half Pastern LH">Half Pastern</option>
...
<td align="center" valign="top">
<p align="right">RH<br>
<select size="1" name="horse_marking_rh_10">
<option value="">No Markings</option>
<option value="Cornet RH">Cornet</option>
<option value="Half Cornet RH">Half Cornet</option>
<option value="Half Pastern RH">Half Pastern</option>
...
<tr>
<td align="center" valign="top" colspan="2">BH<br>
<select size="1" name="horse_marking_bh_10">
<option value="">No Markings</option>
<option value="Cornet BH">Cornet</option>
<option value="Half Cornet BH">Half Cornet</option>
<option value="Half Pastern BH">Half Pastern</option>
